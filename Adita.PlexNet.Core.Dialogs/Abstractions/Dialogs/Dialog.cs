...
namespace Adita.PlexNet.Core.Dialogs.Abstractions.Dialogs
{
    /// <summary>
    /// Represents a base class of a dialog.
    /// </summary>
    public abstract class Dialog : ObservableRecipient, IDialog
    {
        #region Public Properties
        /// <summary>
        /// Gets a <see cref="Core.Dialogs.DialogResult" /> of the dialog.
        /// </summary>
