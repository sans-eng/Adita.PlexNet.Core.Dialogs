...
namespace Adita.PlexNet.Core.Dialogs.Managers
{
    ...
    public class DialogManager<TDialog, TReturn, TParam> : IDialogManager<TDialog, TReturn, TParam>
        where TDialog : class, IDialog<TReturn, TParam>
    {
        ...
        #region Constructors
        /// <summary>
        /// Initialize a new instance of <see cref="DialogManager{TDialog, TReturn, TParam}"/> using specified <paramref name="dialogProvider"/>
