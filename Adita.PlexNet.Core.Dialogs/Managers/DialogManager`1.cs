...
namespace Adita.PlexNet.Core.Dialogs.Managers
{
    ...
    public class DialogManager<TDialog> : IDialogManager<TDialog>
        where TDialog : class, IDialog
    {
        ...
        #region Constructors
        /// <summary>
        /// Initialize a new instance of <see cref="DialogManager{TDialog}"/> using specified <paramref name="dialogProvider"/>
